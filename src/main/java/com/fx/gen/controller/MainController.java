...
import com.fx.gen.controller.tabs.ConstController;
import com.fx.gen.controller.tabs.MapController;
import com.fx.gen.controller.tabs.ResultController;
...
public class MainController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle bundle) {
        ...
        Tab tabMap = HelperFunctions.addTab(bundle, tabPane, Globals.FXML_MAP_PATH, new MapController(this), bundle.getString("tab.p2p"));
        HelperFunctions.addTab(bundle, tabPane, Globals.FXML_CONSTRUCT_PATH, new ConstController(this), bundle.getString("tab.const"));
        ...
        ((PopulateInterface) tabMap.getContent().getUserData()).populate();
    }
